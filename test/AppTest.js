...
//1.注册手机号
/*userApi.registerByPhone({country: '+86', mobile: '138880000000'}).then(function (data) {
...
/*userApi.getUserInfo({ country:"86" , mobile: "138880000000"}).then(function (data) {
    console.debug("获取用户信息结果：------" + JSON.stringify(data));
});*/
...
//5.获取用户指定币账户地址/ 用户未配置币种时：{\"code\":\"100001\",\"msg\":\"系统异常\"}"
accountApi.getDepositAddress({symbol: "eth", uid: "9027408"}).then(function (data) {
